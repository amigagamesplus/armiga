#!/bin/sh
# DESC_ES: Escanea ROMs de Amiga y muestra qué se renombraria (sin tocar ficheros)
# DESC_EN: Scans Amiga ROMs and shows what would be renamed (no files touched)
...
echo "========================================================"
echo "  Escaneo de ROMs Amiga (MODO PRUEBA - sin cambios)"
echo "========================================================"
...
echo "--------------------------------------------------------"
echo ">> [AVISO] MODO PRUEBA: ningun archivo fue modificado."
echo ">> Si los nombres son correctos, ejecuta 'Renombrar ROMs Amiga (aplicar)'."
